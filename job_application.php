                    ...
                    <div class="col-lg-10 col-xl-8">
                        <div class="hero-cap hero-cap2 pt-120">
                            ...
                            <nav aria-label="breadcrumb ">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Emploi</a></li> 
                                    </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-4">
                <div class="col-md-10 text-center">
                    <h3>Formulaire de candidature pour un emploi</h3>
                    <p>Merci de remplir ce formulaire pour soumettre votre demande d’emploi.</p>
                </div>
            </div>
            <form action="process/job_process.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <label>Copie Attestations de travail ou de stage</label>
                        <input type="file" name="attestations[]" accept=".pdf,.jpg,.jpeg,.png" class="form-control" multiple>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        <label>Copie simple de l’acte de naissance</label>
                        <input type="file" name="naissance" accept=".pdf,.jpg,.jpeg,.png" class="form-control" required>
                    </div>
                    <!-- Bouton -->
